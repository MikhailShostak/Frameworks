...
#include <LegacyUI.hpp>

namespace UI
{

class PUBLIC_API_EXPORT BaseSuggestionsComponent : public ItemAdapter
{
...
class PUBLIC_API_EXPORT SuggestionsComponent : public BaseSuggestionsComponent
{
public:
    Array<String> items;
