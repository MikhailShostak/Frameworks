...
class PUBLIC_API_EXPORT SplitViewGestureRecgonizer : public GestureRecognizer
{
...
class PUBLIC_API_EXPORT SplitView : public UI::View
//CLASSGEN END REGION
{
