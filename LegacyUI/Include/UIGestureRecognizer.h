...
class PUBLIC_API_EXPORT AGestureRecognizer : public AObject
{
public:
...
class PUBLIC_API_EXPORT GestureRecognizer : public AGestureRecognizer
{
	View *view = nullptr;
...
class PUBLIC_API_EXPORT ViewEvent : public AEvent
{
    View &view;
public:
...
class PUBLIC_API_EXPORT ViewAcceptableEvent : public AAcceptableEvent
{
    View &view;
public:
...
class PUBLIC_API_EXPORT GestureEvent : public ViewAcceptableEvent
{
