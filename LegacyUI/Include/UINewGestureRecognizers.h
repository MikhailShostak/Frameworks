...
class PUBLIC_API_EXPORT SwipeGestureRecognizer : public GestureRecognizer
{
protected:
...
class PUBLIC_API_EXPORT RubberBandSelection : public GestureRecognizer
{
    Math::IntegerVector startPosition;
...
class PUBLIC_API_EXPORT SignleSelection : public GestureRecognizer
{
public:
...
class PUBLIC_API_EXPORT Highlighting : public GestureRecognizer
{
...
class PUBLIC_API_EXPORT GroupMovement : public GestureRecognizer
{
...
class PUBLIC_API_EXPORT SingleMovement : public GestureRecognizer
{
    Math::IntegerVector startPoisition;
...
class PUBLIC_API_EXPORT Linking : public GestureRecognizer
{
