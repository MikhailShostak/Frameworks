...
//CLASSGEN END REGION
#include "TextButton.gen.h"//TODO:temp include
#include "ListView.gen.h"//TODO:temp include
...
class PUBLIC_API_EXPORT TreeAdapter
{
public:
...
template<typename TreeItemType>
class PUBLIC_API_EXPORT TreeProxy : public ItemAdapter
{
...
template<typename TreeItemType>
class PUBLIC_API_EXPORT TreeView : public ListView
{
...
class PUBLIC_API_EXPORT DefaultTreeItemView : public Overlay
{
