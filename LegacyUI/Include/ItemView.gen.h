...
//CLASSGEN END REGION
#include "UIDataView.h"//TODO:temp include
#include "ScrollView.gen.h"//TODO:temp include
#include "UINewGestureRecognizers.h"//TODO:temp include
...
class PUBLIC_API_EXPORT ItemAdapter
{
public:
...
class PUBLIC_API_EXPORT ItemDataObserver
{
public:
...
class PUBLIC_API_EXPORT ItemView : public DataView<AdapterType, ScrollView>, public ItemDataObserver
{
public:
...
class PUBLIC_API_EXPORT ItemController : public Base, public ItemAdapter
{
public:
