...
struct PUBLIC_API_EXPORT WindowsManager : public ASingleton<WindowsManager>
{
...
class PUBLIC_API_EXPORT Window : public AObject
{
protected:
    AWindow & owner;
...
class PUBLIC_API_EXPORT OpenGLContext : public ASingleton<OpenGLContext>
{
...
class PUBLIC_API_EXPORT OpenGLWindow : public Window
{
