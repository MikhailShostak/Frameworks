...
class PUBLIC_API_EXPORT Console : public ASingleton<Console>
{
...
public:
    ...
    //TODO: copy optimize
    String getPreviousCommand() const
    {
        if (currentCommand > 0)
        {
...
class PUBLIC_API_EXPORT ConsoleVariable
{
    Type value;
public:
