...
class PUBLIC_API_EXPORT APngFormat : public APixmapFormat
{
public:
...
/*class ATGAFormat : public APixmapFormat
{
    typedef struct
    {
...
public:
    ...
    virtual bool isValid(const String &path) const
    {
        return true;
    }
    ...
    virtual void save(const String &path, const APixmap &pixmap) const;
    virtual APixmap load(const String &path) const;
