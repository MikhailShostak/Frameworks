...
//PUBLIC_API_EXPORT void Load(EScene &scene);
//PUBLIC_API_EXPORT void Unload(EScene& scene);
//PUBLIC_API_EXPORT void Update(EScene& scene);
//
...
template<typename ...ComponentTypes>
inline EntityTemplate<ComponentTypes...> CreateEntity(Graphics::Scene& scene)
{
    const auto ID = scene.Registry.create();
    return {
        { &scene, ID, }, { scene.Registry.emplace<ComponentTypes>(ID)... }
    };
}

inline ECS::Entity CreateEntity(Graphics::Scene& scene, const ECS::EntityDefinition &Definition)
{
    ECS::Entity Entity = ECS::CreateEntity(scene);
    Serialization::Deserialize(Definition.InstanceData, Entity);
    return Entity;
}
...
//        {
//            result = { ECS::Entity{ &Scene, id }, &component };
//        }
//    }*/
//    return result;
//};
