...
PUBLIC_API_EXPORT SharedReference<Graphics::Texture> CreateTexture(const Color& color, const Int3& size)
{
...
PUBLIC_API_EXPORT void SaveTexture(const Graphics::Texture &texture, const System::Path &path)
{
