...
class PUBLIC_API_EXPORT CanvasCamera : public APerspectiveCamera
{
public:
...
class PUBLIC_API_EXPORT Canvas : public HardwareHandle<Canvas>, public GraphicsContext
{
...
public:
    ...
    const ::SharedReference<ACamera> &getCamera() const { return camera; }
