...
PUBLIC_API_EXPORT void glCheckErrors(bool skip = false);

template<typename ReturnType, typename ...Types, typename ...Arguments>
PUBLIC_API_EXPORT ReturnType glGet(ReturnType(*api)(Types ...), Arguments &&...arguments)
{
...
PUBLIC_API_EXPORT void glCall(void(*api)(Types ...), Arguments &&...arguments)
{
...
template<>
struct PUBLIC_API_EXPORT HardwareObject<Canvas>
{
...
template<>
struct PUBLIC_API_EXPORT HardwareObject<Material>
{
...
template<>
struct PUBLIC_API_EXPORT HardwareObject<Mesh>
{
...
template<>
struct PUBLIC_API_EXPORT HardwareObject<Texture>
{
    GLuint textureID = 0;
