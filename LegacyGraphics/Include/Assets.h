...
class PUBLIC_API_EXPORT BaseAssetValue
{
protected:
    AssetID assetID;
    Asset *asset = nullptr;
...
class PUBLIC_API_EXPORT Asset final
{
    AssetID id;
...
template<typename Type>
class PUBLIC_API_EXPORT AssetValue : public BaseAssetValue
{
public:
...
template<typename Type>
class PUBLIC_API_EXPORT AssetValue<::SharedReference<Type>> : public BaseAssetValue
{
public:
    using BaseAssetValue::BaseAssetValue;
...
class PUBLIC_API_EXPORT AssetsRepository
{
