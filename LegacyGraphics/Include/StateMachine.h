...
class PUBLIC_API_EXPORT StateMachine : public AObject
{
...
struct PUBLIC_API_EXPORT StaticState
{
    VoidFunctionPointer enter;
    VoidFunctionPointer exit;
};

struct PUBLIC_API_EXPORT StaticStackState
{
...
struct PUBLIC_API_EXPORT DynamicState
{
...
struct PUBLIC_API_EXPORT DynamicStackState
{
    VoidFunctionPointer create;
    VoidFunctionPointer destroy;
    VoidFunctionPointer update;
...
class PUBLIC_API_EXPORT StateMachine
{
protected:
    StateType instance;
...
template<typename StateType, const StateType states[], size_t size, typename _StatesEnumeration, _StatesEnumeration entryPoint, bool autoEnter = true>
class PUBLIC_API_EXPORT StackBasedStateMachine : public StateMachine<StateType, states, size, _StatesEnumeration, entryPoint, autoEnter>
{
protected:
...
class PUBLIC_API_EXPORT DynamicStateMachine : public StateMachineType
{
public:
