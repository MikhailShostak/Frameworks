...
class PUBLIC_API_EXPORT MaterialInterface
{
public:
...
struct PUBLIC_API_EXPORT MaterialData
{

};

class PUBLIC_API_EXPORT Material : public HardwareHandle<Material>, public MaterialInterface
{
...
#define DeclareDynamicMaterial(name, structure) \
 class PUBLIC_API_EXPORT Dynamic ## name : public Legacy::Graphics::MaterialInterface \
{ \
