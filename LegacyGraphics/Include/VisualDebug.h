...
struct PUBLIC_API_EXPORT Shape
{
public:

};

struct PUBLIC_API_EXPORT BoxShape : public Shape
{
public:
    Math::Vector halfExtents;
};

struct PUBLIC_API_EXPORT SphereShape : public Shape
{
public:
    float radius = 0;
};

struct PUBLIC_API_EXPORT CapsuleShape : public Shape
{
public:
    float radius = 0;
    float height = 0;
...
class PUBLIC_API_EXPORT DebugRenderer
{
public:
