...
template<typename Type, typename ...Arguments>
[[nodiscard]] inline SharedReference<Type> CreateShared(Arguments &&...arguments)
{
    return SharedReference<Type>(Create<Type>(std::forward<Arguments>(arguments)...));
}

template<typename Type, typename ...Arguments>
[[nodiscard]] inline UniqueReference<Type> CreateUnique(Arguments &&...arguments)
{
    return UniqueReference<Type>(Create<Type>(std::forward<Arguments>(arguments)...));
}
