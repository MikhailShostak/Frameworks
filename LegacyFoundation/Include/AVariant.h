...
class PUBLIC_API_EXPORT AVariant final
{
...
{
    data = std::make_unique<AVariantValueData<typename std::remove_const<typename std::remove_reference<Type>::type>::type>>(std::forward<Type>(value));
}
