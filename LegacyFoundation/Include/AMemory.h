...
struct PUBLIC_API_EXPORT SharedReferenceCounter
{
...
template<typename Type>
class PUBLIC_API_EXPORT SharedReference final
{
...
template<typename Type>
class PUBLIC_API_EXPORT WeakReference final
{
...
template<typename Type>
class PUBLIC_API_EXPORT UniqueReference
{
...
using AbstractConstructor = Memory::Constructor<void, Arguments...>;
