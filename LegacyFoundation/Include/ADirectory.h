...
class PUBLIC_API_EXPORT ADirectoryIterator
{
...
enum class PUBLIC_API_EXPORT AFindFilter
{
    Files = 0x1,
    Directories = 0x2,
    Hidden = 0x4,
...
class PUBLIC_API_EXPORT ADirectory
{
...
class PUBLIC_API_EXPORT DirectoryEnumerator
{
public:
    const ADirectory &directory;
