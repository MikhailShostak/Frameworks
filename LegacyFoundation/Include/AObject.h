...
class PUBLIC_API_EXPORT AEventListener final
{
...
class PUBLIC_API_EXPORT AEventObserver
{
public:
...
class PUBLIC_API_EXPORT AObject : public AEventObserver, public Serializable
{
protected:
...
class PUBLIC_API_EXPORT AEventChannel : public AEventObserver
{
