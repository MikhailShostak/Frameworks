...
enum class PUBLIC_API_EXPORT AOperationPriority
{
    High,
    Medium,
    Low
...
class PUBLIC_API_EXPORT AOperation
{
...
struct PUBLIC_API_EXPORT AOperationCallbacks
{
...
class PUBLIC_API_EXPORT AOperationQueue
{
...
class PUBLIC_API_EXPORT AMultiThreadedLoop : public ARunLoop
{
...
class PUBLIC_API_EXPORT AOperationDispatcher : public ARunnable
{
public:
