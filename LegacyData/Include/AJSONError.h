...
enum class PUBLIC_API_EXPORT AJSONWriteOption
{
    Comapct,
    Formated
};

enum class PUBLIC_API_EXPORT AJSONErrorCode : uint8_t
{
    Null = 0,
    EmptyDocument,
...
class PUBLIC_API_EXPORT AJSONError final : public AError
{
public:
    AJSONError():AError() {}
