...
class PUBLIC_API_EXPORT AJSONParser
{
public:
...
class PUBLIC_API_EXPORT AJSONStringParser : public AJSONParser
{
public:
...
class PUBLIC_API_EXPORT AJSONFileParser : public AJSONParser
{
public:
