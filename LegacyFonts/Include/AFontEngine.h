...
#include "TextAlign.gen.h"
#include "TextWrapping.gen.h"
...
class PUBLIC_API_EXPORT FontEngine final : public ASingleton<FontEngine>
{
    friend class Font;
...
public:
    ...
    class PUBLIC_API_EXPORT GlyphData
    {
    public:
        uint32_t index = 0;
    ...
    class PUBLIC_API_EXPORT FontChache final
    {
    public:
    ...
    class PUBLIC_API_EXPORT FontData final
    {
    ...
    struct PUBLIC_API_EXPORT GlyphInfo
    {
        uint32_t width = 0;
        const FontEngine::GlyphData* glyph = nullptr;
    };

    struct PUBLIC_API_EXPORT LineInfo
    {
        size_t lenght = 0;
        int32_t offset = 0;
        int32_t width = 0;
